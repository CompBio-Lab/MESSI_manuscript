...
# Main code here
trace_path <- "data/raw/multimodal_data/execution_trace.txt"
# Read the trace in
...
metadata_path <- "data/raw/multimodal_data//parsed_metadata.csv"
...
out_plot <- combined_df %>%
  ...
  labs(x = "Dataset Size", y = "Median Memory (MB)")
