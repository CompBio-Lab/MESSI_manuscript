...
out_plot <- df_sig_counts %>%
  ggplot(aes(y = reorder(method, n_sig_pathways, FUN=sum),
             x = n_sig_pathways, fill = celltype)) +
...
out_plot
output_png_path <- "results/sc/fig6n_sc_covid_multiomics_pathways.png"
