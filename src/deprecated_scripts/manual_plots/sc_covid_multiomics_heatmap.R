...
wrapped_text <- stringr::str_wrap(colnames(nes), 24)
...
#       show_heatmap_legend = FALSE,
       ...
       #padding = unit(c(170, 0, 0, 0), "mm"),  # bottom, left, top, right
       padding = unit(c(20, 0, 0, 0), "mm")
  )
)

ggsave("aaa.svg", ht_grob, width=12, height=18, dpi=1200)
