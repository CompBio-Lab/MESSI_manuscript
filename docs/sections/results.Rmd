...
```{r fs-selection-real-tbl}
fs_selection_real_tbl <- readRDS(here::here("data/processed/fig_feature_selection_real_plot_data.rds"))

fs_selection_real_tbl["sgcca-full-ncomp-2 + lda", "diablo-full-ncomp-1"]

fs_selection_real_tbl |> colnames()
```
